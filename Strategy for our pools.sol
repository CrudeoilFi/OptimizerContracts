...
interface DIESELBNB_V2_CRUDEOIL {
...
contract StratXAll is Ownable, ReentrancyGuard, Pausable {
    ...
    function setData (
        ...
        if (isAutoComp) {
            ...
            earnedToCRUDEPath = [earnedAddress, wbnbAddress, CRUDEAddress];
            if (wbnbAddress == earnedAddress) {
                earnedToCRUDEPath = [wbnbAddress, CRUDEAddress];
            }
    ...
    function _farm() internal {
        ...
        DIESELBNB_V2_CRUDEOIL(farmContractAddress).stake(wantAmt); 
        }
    }
        ...
        returns (uint256)
    {
        ...
        lastUser = _userAddress;
        if (isAutoComp) {
                DIESELBNB_V2_CRUDEOIL(farmContractAddress).withdrawAmount(_wantAmt); 
        }
    ...
    function earn() public whenNotPaused {
        ...
        DIESELBNB_V2_CRUDEOIL(farmContractAddress).getReward();         
