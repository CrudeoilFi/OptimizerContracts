...
contract StratXCake is Ownable, ReentrancyGuard, Pausable {
  ...
  function setData(
    ...
    function setEntranceFeeFactor(uint256 _entranceFeeFactor) public onlyGovAddress{
        require(_entranceFeeFactor > entranceFeeFactorLL, "too low");
        require(_entranceFeeFactor <= entranceFeeFactorMax, "too high");
        entranceFeeFactor = _entranceFeeFactor;
    }

    function setControllerFee(uint256 _controllerFee) public onlyGovAddress{
        require(_controllerFee <= controllerFeeUL, "too high");
        controllerFee = _controllerFee;
    }

    function setbuyBackRate(uint256 _buyBackRate) public onlyGovAddress {
