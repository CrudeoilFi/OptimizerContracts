...
contract StratXBake is Ownable, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    ...
    bool public addLiquidityStatus = false;
    ...
    function _farm() internal {
        ...
        BakeryMaster(farmContractAddress).deposit(wantAddress,wantAmt); 
        }
    }
        ...
        returns (uint256)
    {
      ...
      address  lastUser = _userAddress;
        if (isAutoComp) {
                BakeryMaster(farmContractAddress).withdraw( wantAddress,_wantAmt); 
        }
    ...
    function earn() public whenNotPaused {
        ...
        BakeryMaster(farmContractAddress).withdraw(wantAddress,0);         
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        IERC20(CRUDEAddress).safeTransfer(govAddress, burnAmt.div(2));
